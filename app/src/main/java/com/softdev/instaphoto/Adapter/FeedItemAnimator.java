...
public class FeedItemAnimator extends DefaultItemAnimator {
    ...
    public boolean animateChange(@NonNull RecyclerView.ViewHolder oldHolder,
        ...
        if (preInfo instanceof FeedItemHolderInfo) {
            ...
            updateLikesCounter(holder, holder.getFeedItem().likes + 1);
            if (Config.ACTION_LIKE_IMAGE_CLICKED.equals(feedItemHolderInfo.updateAction)) {
    ...
    private void updateLikesCounter(FeedAdapter.CellFeedViewHolder holder, int toValue) {
        String likesCountTextFrom = holder.txtLikesCounter.getResources().getQuantityString(
                R.plurals.likes_count, toValue - 1, toValue - 1
        );
        holder.txtLikesCounter.setCurrentText(likesCountTextFrom);

        String likesCountTextTo = holder.txtLikesCounter.getResources().getQuantityString(
                R.plurals.likes_count, toValue, toValue
        );
        holder.txtLikesCounter.setText(likesCountTextTo);
    }
    ...
    private void animateHeartButton(final FeedAdapter.CellFeedViewHolder holder) {
        ...
        bounceAnimY.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationStart(Animator animation) {
                holder.btnLike.setImageResource(!holder.getFeedItem().isLiked() ? R.drawable.ic_heart_outline_grey : R.drawable.ic_heart_red);
            }
    ...
    private void animatePhotoLike(final FeedAdapter.CellFeedViewHolder holder) {
        ...
        //holder.imgLike.setScaleY(0.1f);
        //holder.imgLike.setScaleX(0.1f);

        AnimatorSet animatorSet = new AnimatorSet();

        ObjectAnimator imgScaleUpYAnim = ObjectAnimator.ofFloat(holder.imgLike, "scaleY", 0.1f, 1f);
        imgScaleUpYAnim.setDuration(300);
        imgScaleUpYAnim.setInterpolator(DECCELERATE_INTERPOLATOR);
        ObjectAnimator imgScaleUpXAnim = ObjectAnimator.ofFloat(holder.imgLike, "scaleX", 0.1f, 1f);
        imgScaleUpXAnim.setDuration(300);
        imgScaleUpXAnim.setInterpolator(DECCELERATE_INTERPOLATOR);

        ObjectAnimator imgScaleDownYAnim = ObjectAnimator.ofFloat(holder.imgLike, "scaleY", 1f, 0f);
        imgScaleDownYAnim.setDuration(300);
        imgScaleDownYAnim.setInterpolator(ACCELERATE_INTERPOLATOR);
        ObjectAnimator imgScaleDownXAnim = ObjectAnimator.ofFloat(holder.imgLike, "scaleX", 1f, 0f);
        imgScaleDownXAnim.setDuration(300);
        imgScaleDownXAnim.setInterpolator(ACCELERATE_INTERPOLATOR);

        animatorSet.playTogether(imgScaleUpYAnim, imgScaleUpXAnim);
        animatorSet.play(imgScaleDownYAnim).with(imgScaleDownXAnim).after(imgScaleUpYAnim).after(500);
